...
__all__ = ['gl1gbn_resnet18', 'gl1gbn_resnet34', 'gl1gbn_resnet50', 'gl1gbn_resnet101',
           'gl1gbn_resnet152']
...
class GL(nn.Module):
    ...
    def forward(self, x): # (b, c, h, w)
        ...
        bx = self.bn(gx.view(-1, 1, 1, 1)).view(-1, self.c, 1, 1)
...
def gl1gbn_resnet18(pretrained=False, **kwargs):
...
def gl1gbn_resnet34(pretrained=False, **kwargs):
...
def gl1gbn_resnet50(pretrained=False, **kwargs):
...
def gl1gbn_resnet101(pretrained=False, **kwargs):
...
def gl1gbn_resnet152(pretrained=False, **kwargs):
